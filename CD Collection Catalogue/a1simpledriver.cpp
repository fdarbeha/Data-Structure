...
void TestFunc1()
{
    ...
    CD myCD = CD("KISS1", "Destroyer2");
    cat1.Insert(myCD);
    
    cout <<"Index of KISS1/Destroyer2 is: " << cat1.Find(myCD)<<endl;
...
void TestFunc2()
{
    ...
    cat1.PrintCollection();
    cat2.PrintCollection();
    catjoin.PrintCollection();
    CDCatalogue catcommon(cat1.Common(cat2));
    catcommon.PrintCollection();
    CDCatalogue catsplit(cat1.Split(cat2));
    catsplit.PrintCollection();
}
